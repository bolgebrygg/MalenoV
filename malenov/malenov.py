...
def main():
    ...
    pred_dict = {
        'keras_model' :  keras.models.load_model(filedir+'mulitvolume_multifacies.h5'), # input model to be used for prediction, to load a model use: keras.models.load_model('write_location')
