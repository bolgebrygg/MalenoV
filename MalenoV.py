...
train_dict = {
    ...
    'save_location' : 'F3_test1'    # file name for the saved trained model
}
...
pred_dict = {
    ...
    'save_pred' : False,    # Save the prediction as a segy-cube
    'save_location' : 'test_prediction.segy',     # file name for the saved prediction
